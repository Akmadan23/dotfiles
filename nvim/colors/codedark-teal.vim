" Fork of the Vim Code Dark color scheme
...
let s:cdBack = {'gui': '#242424', 'cterm': s:cterm00, 'cterm256': '234'}

let s:cdTabCurrent = {'gui': '#242424', 'cterm': s:cterm00, 'cterm256': '234'}
...
let s:cdCursorDarkDark = {'gui': '#101010', 'cterm': s:cterm01, 'cterm256': '235'}
let s:cdCursorDark = {'gui': '#51504F', 'cterm': s:cterm03, 'cterm256': '239'}
let s:cdCursorLight = {'gui': '#AEAFAD', 'cterm': s:cterm04, 'cterm256': '145'}
let s:cdSelection = {'gui': '#24574D', 'cterm': s:cterm03, 'cterm256': '24'}
...
let s:cdBlue = {'gui': '#1ACB9C', 'cterm': s:cterm0D, 'cterm256': '75'}
